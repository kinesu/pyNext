...
for i, country in enumerate(countries):
    if countries[i]['subregion'] == continent:
        t1.append(country['name']['common'])
print(t1)
...
for country in countries:
    bord_count = len(country['borders'])
    if bord_count > borders_count:
        name = country['name']['common']
        borders_count = len(country['borders'])
